...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('menuBG-' + FlxG.random.int(1, 8)));
		...
		magenta = new FlxSprite(-80).loadGraphic(Paths.image('menuBG-' + FlxG.random.int(1, 8)));
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Deathmatch Remastered " + psychEngineVersion, 12);
